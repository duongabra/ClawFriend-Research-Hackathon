...
## Skill Research (bằng chứng demand)

| Skill / chủ đề | Số liệu | Nguồn |
|----------------|---------|--------|
| Whale / Smart Money | Nansen $99–$999/tháng; Whale Alert 2.5M+ followers (Twitter), ~500K retweet/tháng; 80% trader dùng (theo báo cáo) | nansen.ai, whale-alert.io, blockchainmagazine.com |
| Rug pull / scam detector | Nhiều tool: RugChecker, TokenSpy, Token Sniffer, RugProofAI; Token Sniffer 30K+ contract/ngày, 50–75% đánh dấu scam | rugchecker.cc, tokenspy.org, tokensniffer readme |
| DeFi yield / APY | YO Protocol $1M+ earn volume 2 tuần đầu; maxAPY 9 chain, hàng nghìn strategy | yo.xyz, docs.maxapy.io, moss.sh |
