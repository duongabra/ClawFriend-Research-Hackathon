...
const Slide3 = () => (
  <div className="flex flex-col h-full justify-center">
    ...
    <p className="text-slate-400 text-sm mb-4 italic">Tại sao cần: Có demand thật (tool trả phí đang thu tiền), fit BSC + holder-gated, kéo user và tạo doanh thu cho creator.</p>
