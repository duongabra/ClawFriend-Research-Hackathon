...
const TOP_10_SKILLS = [
  { name: 'Real-time Whale / Smart Money Tracker', icon: Wallet, topic: 'Scrypto', user: 'Trader crypto/DeFi $5K–$100K', problem: 'Mất 2–3h/ngày theo dõi ví whale; bỏ lỡ giao dịch.', alt: 'Nansen $99–$999/tháng; Whale Alert 2.5M+ followers', solution: 'Agent theo dõi 500+ ví BSC; alert 30–60s khi whale move > ngưỡng.', visibility: 'Public free → holder-gated (filter nâng cao)', proof: 'Nansen $99+/tháng; Whale Alert 2.5M followers = demand.' },
  ...
  { name: 'KOL / Influencer Track & Mention Alert', icon: MessageSquare, topic: 'Alpha & Social', user: 'Trader theo dõi 10–50 KOL', problem: 'Mention quan trọng chìm trong feed; bỏ lỡ tín hiệu.', alt: 'TweetDeck, Nansen/Token Metrics', solution: 'Theo dõi list handle; detect mention token; alert khi có mention + link tweet.', visibility: 'Public 3–5 KOL + holder-gated list lớn', proof: '"When did X mention Y" rất phổ biến; KOL call move giá.' },
  ...
  { name: 'No-code Workflow Builder (kết nối app + trigger)', icon: Cpu, topic: 'AI / Bot', user: 'User không code; muốn "khi A thì B"', problem: 'Zapier/Make đắt khi nhiều task.', alt: 'Zapier, Make, n8n', solution: 'Mô tả bằng ngôn ngữ tự nhiên; agent gợi ý trigger → action.', visibility: 'Public 1 workflow, 50 run + holder-gated unlimited', proof: 'Zapier valuation tỷ USD; no-code trend.' },
  { name: 'Meeting Notes → Tasks (biên bản → action items)', icon: FileText, topic: 'Tin tức & Productivity', user: 'PM, nhân viên văn phòng', problem: 'Extract action items thủ công tốn thời gian.', alt: 'Otter.ai, Fireflies, Notion AI', solution: 'Upload transcript/paste notes; agent extract task + owner + deadline.', visibility: 'Public 5 meeting/tháng + holder-gated unlimited + integration', proof: 'Otter, Fireflies thu phí; meeting fatigue.' },
];
