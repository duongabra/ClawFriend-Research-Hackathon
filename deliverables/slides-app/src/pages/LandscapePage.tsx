...
// v2.3: Hedera metrics thực (3 plugin, GitHub); SkillGem/ClawMarket/MoltBazaar có note metric feature/capacity
const COMPETITORS = [
  { name: 'ClawHub (OpenClaw)', links: ['https://openclaw.ai', 'https://claw-hub.net'], type: 'Skill registry', chain: 'Đa nền tảng', metrics: '5.700+ skill; 1,5M+ download; 180K+ GitHub stars', metricNote: '', desc: 'Framework agent mã nguồn mở + skill registry. Không marketplace thương mại; không bonding curve.', monetize: 'Free; không monetization.', strengths: 'Kho skill lớn nhất; semantic search; version control.', weaknesses: 'Không shares, fee; không identity agent.', choose: 'Cần tìm skill nhanh, free.', notChoose: 'Muốn kiếm tiền từ skill.', lesson: 'ClawFriend bổ trợ: holder-gated + 5% fee + identity agent.' },
  { name: 'Heurist Mesh', links: ['https://mesh.heurist.ai'], type: 'Marketplace skill agent', chain: 'Web3 / đa chain', metrics: '25 provider; 100 tool; 40 agent; X402 + ERC-8004', metricNote: '', desc: 'Marketplace skill cho agent Web3: tool crypto, REST, x402 trả theo lượt.', monetize: 'API key; x402 pay-per-request.', strengths: 'Crypto-native; reputation on-chain.', weaknesses: 'Không bonding curve, không BSC.', choose: 'Agent cần data/tool Web3.', notChoose: 'Cần share agent hoặc social.', lesson: 'ClawFriend: BSC + bonding curve + holder-gated skill.' },
  { name: 'SkillGem', links: ['https://skillgem.ai'], type: 'Skill + monetization', chain: 'x402 / ERC-8004', metrics: '20+ nền tảng; x402 pay-per-use', metricNote: 'Chưa công bố user/revenue; số liệu = feature/capacity.', desc: 'Đóng gói chuyên môn thành skill (no code); micropayment x402.', monetize: 'x402 trả theo lượt dùng.', strengths: 'No-code; đa nền tảng; reputation on-chain.', weaknesses: 'Không token hóa agent; skill đứng riêng.', choose: 'Creator bán skill no-code.', notChoose: 'Cần gắn skill với share agent.', lesson: 'Holder-gated → demand skill = demand share.' },
  { name: 'Hedera Agent Marketplace', links: ['https://hedera.opspawn.com', 'https://github.com/hedera-dev/hedera-agent-skills'], type: 'Agent + skill registry', chain: 'Hedera', metrics: '3 plugin/skills; GitHub 4 stars, 1 fork; HCS-26', metricNote: 'Metric hạn chế; dùng repo + số plugin.', desc: 'Marketplace agent AI privacy trên Hedera; skill registry HCS-26.', monetize: 'Không rõ công khai.', strengths: 'Privacy, compliance; chuẩn skill.', weaknesses: 'Gắn Hedera; không BSC, bonding curve.', choose: 'Cần privacy/build trên Hedera.', notChoose: 'Cần BSC, bonding curve.', lesson: 'ClawFriend focus BSC, bonding curve, social.' },
  { name: 'ClawMarket', links: ['https://www.claw-market.xyz'], type: 'Skill marketplace paid/free', chain: 'Base, Ethereum', metrics: '15+ skills; USDC escrow', metricNote: 'Chưa công bố user/GMV; (1) capacity, (2) feature.', desc: 'Skill marketplace Base + ETH: wallet auth, USDC escrow, API-first.', monetize: 'USDC escrow; free + paid skills.', strengths: 'Crypto-native; API cho agent.', weaknesses: '15+ skill; không share agent.', choose: 'Mua skill USDC Base/ETH.', notChoose: 'Cần BSC, holder-gated.', lesson: 'ClawFriend: BSC + shares + holder-gated.' },
  { name: 'MoltBazaar', links: ['https://moltbazaar.ai'], type: 'Agent marketplace + skills', chain: 'Base', metrics: 'ERC-8004; verified skills; USDC + x402', metricNote: 'Chưa công bố user/volume; số liệu = feature/capacity.', desc: 'Người thuê agent làm task; verified skills từ openclaw-skills.', monetize: 'USDC + x402; bounties, subscriptions.', strengths: 'Agent identity + verified skills; pay-per-task.', weaknesses: 'Focus hire agent; không BSC.', choose: 'Thuê agent task trên Base.', notChoose: 'Bán skill holder-gated.', lesson: 'ClawFriend: skill market + share trading + social.' },
];
