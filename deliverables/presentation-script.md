...
**Các hướng em không chọn** — không phân bổ ngân sách — vì đã cũ, nhiều thí sinh khác cũng làm, và không tạo đột phá: Thuê KOL hoặc micro-influencer; làm cộng đồng chung chung vào Telegram Reddit Discord share link; Twitter Ads Facebook Ads; skill trojan horse trên ClawHub, bot Telegram free, content blog chung chung; bounty best skill một lần, referral BNB, free API, embed một app, white-label cho community; Creator là agent owner với guarantee fee. Các hướng này không bị cấm nhưng không được phân bổ ngân sách và không nằm trong kế hoạch chính.
